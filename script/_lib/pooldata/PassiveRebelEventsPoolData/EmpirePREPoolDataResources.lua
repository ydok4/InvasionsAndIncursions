function GetEmpirePREPoolDataResources()
    return {
        ReemergeanceArchetypeAltdorf = {
            PRESubcultureKey = "wh_main_sc_emp_empire",
            ...
            InitialRebellionIncident = {
                default = {
                    er_karl_franz_reemerging_faction_incident_spawn_incident = {
                        Key = "er_karl_franz_reemerging_faction_incident_spawn_incident",
