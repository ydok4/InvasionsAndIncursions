function GetTombKingsPREPoolDataResources()
    return {
        ReemergeanceArchetypeKhemri = {
            PRESubcultureKey = "wh2_dlc09_sc_tmb_tomb_kings",
            ...
            InitialRebellionIncident = {
                default = {
                    er_settra_reemerging_faction_incident_spawn_incident = {
                        Key = "er_settra_reemerging_faction_incident_spawn_incident",
